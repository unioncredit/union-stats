import { Heading, Box, Text, Pagination, Header } from "@unioncredit/ui";
                ...
                <tr className={style.bodyItem} key={tableData}>
                  ...
                  <td className={style.bodyItemAccount}>
                    <span className={style.ensName}>
                      {row.borrower.slice(0, 10)}
                    </span>
                    <span className={style.address}>elses.eth</span>
                  ...
                  <td>{row.stakeAmount.toString().slice(0, 6)}</td>
                  <td>{row.borrowAmount.toString().slice(0, 6)}</td>
                  <td>{row.repayAmount.toString().slice(0, 6)}</td>
                  <td>{row.unstakeAmount.toString().slice(0, 6)}</td>
